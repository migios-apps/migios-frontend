...
import { TrainerDetail } from "@/services/api/@types/trainer"
                ...
                <CardContent className="flex items-center gap-4 p-4">
                  ...
                  <div className="space-y-1">
                    <div className="flex items-center gap-2">
                      <h2 className="group-hover:text-primary text-xl font-bold tracking-tight">
                        {trainer.name}
                      </h2>
                    </div>
                    ...
                    {trainer.specializations?.length > 0 && (
                      <p className="text-muted-foreground text-[10px] font-bold tracking-wider capitalize">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center gap-2.5">
                        ...
                        <div className="min-w-0">
                          <p className="text-muted-foreground/70 text-[10px] font-bold capitalize">
                            Email
                          </p>
                      ...
                      {trainer.address && (
                        <div className="flex items-start gap-2.5">
                          ...
                          <div className="min-w-0">
                            ...
                            <p className="text-muted-foreground line-clamp-2 text-[11px] leading-tight font-medium">
                              {trainer.address}
                            </p>
                          </div>
                        </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center gap-2.5">
                        ...
                        <div className="min-w-0">
                          ...
                          <p className="text-xs font-semibold">
                            {trainer.gender === "f" ? "Perempuan" : "Laki-laki"}
                          </p>
                        </div>
                      </div>
                      {trainer.birth_date && (
                        <div className="flex items-center gap-2.5">
                          ...
                          <div className="min-w-0">
                            ...
                            <p className="text-xs font-semibold">
                              {new Date(trainer.birth_date).toLocaleDateString(
                                "id-ID",
                                  ...
                                  <CardContent className="bg-card p-3">
                                    ...
                                    <div className="space-y-1.5">
                                      ...
                                      {member.total_active_packages > 2 && (
                                        <p className="text-muted-foreground pt-0.5 text-center text-[10px] font-bold tracking-widest uppercase">
                                          + {member.total_active_packages - 2}{" "}
                                          Paket Lainnya
                                        </p>
                                      )}
