...
const EmployeeLayout = ({ children }: { children?: React.ReactNode }) => {
  ...
  // If exact match doesn't exist (e.g. sub-routes), default to /employee or logic as needed
  // For strict matching as per request:
  const activeValue = tabItems.some((item) => item.route === pathname)
    ? pathname
    : routeEmployee // Default fallback or logic to handle sub-routes if needed
