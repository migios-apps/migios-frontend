...
const tabItems = [
  ...
  { route: "/reports/packages", label: "Paket dan Plan" },
  { route: "/reports/products", label: "Produk" },
  { route: "/reports/finance", label: "Keuangan" },
  { route: "/reports/members", label: "Member" },
  { route: "/reports/employee", label: "Karyawan" },
]
