                  ...
                  <Card className="gap-3 shadow-none">
                    ...
                    <CardContent className="space-y-4">
                      <div className="space-y-2">
                        ...
                        <p className="text-muted-foreground text-sm">
                          Jika tidak diaktifkan, poin tetap sama tanpa
                          kelipatan.
                        </p>
                      </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-muted-foreground text-sm">
                          ...
                          pembelian meskipun mereka menggunakan poin untuk
                          redeem reward. Jika tidak diaktifkan, customer tidak
                          akan mendapatkan poin dari pembelian jika mereka
                          menggunakan poin untuk redeem.
                        </p>
                      </div>
                    </CardContent>
                  </Card>
                    ...
                    <CardContent className="space-y-6">
                      ...
                      <Alert className="border-yellow-200 bg-yellow-50 dark:border-yellow-800 dark:bg-yellow-950">
                        ...
                        <AlertDescription className="text-sm">
                          Pelanggan akan mendapatkan poin setelah membeli
                          pesanan dalam jumlah tertentu sebagai pengaturan
                          berikut. Jika fitur ini diaktifkan, poin yang
                          didapatkan berdasarkan item tidak lagi didapatkan.
                        </AlertDescription>
                      </Alert>
                      ...
                      <div className="grid w-full grid-cols-1 gap-4 md:grid-cols-2">
                        ...
                        <FormFieldItem
                          ...
                          errorMessage={
                            formState.errors
                              .loyalty_points_earned_by_total_order?.message
                          }
                          render={({ field }) => (
