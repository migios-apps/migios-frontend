      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        ...
        <Card>
          ...
          <CardContent className="grid gap-6 md:grid-cols-2">
            ...
            <FormFieldItem
              control={form.control}
              name="remoteCity"
              label="Kota Remote (Migios Async Select)"
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Input dengan slider</CardDescription>
          </CardHeader>
          <CardContent>
            <FormField
              control={form.control}
              ...
              render={({ field: { value, onChange } }) => (
                <FormItem>
                  <FormLabel>Pengalaman Kerja: {value} tahun</FormLabel>
                  <FormControl>
                    <Slider
                      min={0}
                      max={20}
                  ...
                  <FormDescription>
                    Geser untuk memilih tahun pengalaman
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
