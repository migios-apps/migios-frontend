...
import { useSidebar } from "./layout/vertical/sidebar"
...
function ThemeConfig() {
  ...
  return (
    <div>
      <SectionTitle
        title="Theme"
        showReset={themeConfig.theme !== defaultTheme}
        onReset={() => setThemeConfig({ theme: defaultTheme })}
      />
      <Radio
        value={themeConfig.theme}
        onValueChange={(value) =>
          setThemeConfig({ theme: value as "light" | "dark" | "system" })
        }
